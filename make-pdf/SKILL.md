...
$HOME/.claude/skills/gstack/bin/gstack-timeline-log '{"skill":"make-pdf","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
[ -z "$P" ] && P="$HOME$HOME/.claude/skills/gstack/make-pdf/dist/pdf"
if [ -x "$P" ]; then
